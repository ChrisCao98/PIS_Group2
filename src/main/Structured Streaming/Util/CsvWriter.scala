...
class CsvWriter extends CommonWriter("/home/chriscao/IdeaProjects/PIS_Group2/data/gps.csv") {

}
//class CsvWriter extends ForeachWriter[SaveInfo_Java]{
//  val filePath = "/home/chriscao/IdeaProjects/PIS_Group2/data/gps.csv"
